    ...
    <div v-if="!submitted">
      <form  class="submit-form">
        ...
        <div class="mb-3">
              ...
              <input :class="{valid : isValidCNPJ == true, inValid: isValidCNPJ == false}" type="text" v-model="pessoa.cliente.cnpj" class="form-control " id="inputCNPJ"
      ...
      <router-link to="/home" class="btn btn-success">Voltar</router-link>
...
export default {
  ...
  Soma = 0;
    ...
    isValidCNPJ (){
      if (!this.pessoa.cliente.cnpj) {
        return false
      } else {
        if (this.pessoa.cliente.cnpj.length == 14) {
          return true
      } else {
        return false
      }
